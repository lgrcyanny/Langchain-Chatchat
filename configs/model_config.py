...
MODEL_ROOT_PATH = "/home/zhangyunhao/project/model"
...
MODEL_PATH = {
    "embed_model": {
        ...
        "stella-large-zh-v2": "infgrad/stella-large-zh-v2",
    ...
    "llm_model": {
        ...
        # "baichuan2-13b-4bits": "baichuan-inc/Baichuan2-13B-Chat-4bits",
...
# 选用的 Embedding 名称
EMBEDDING_MODEL = "stella-large-zh-v2" # 可以尝试最新的嵌入式sota模型：piccolo-large-zh
